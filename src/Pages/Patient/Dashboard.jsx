        ...
        <Container maxWidth="lg" className={classes.container}>
          ...
          >
            <Grid item xs={12} md={8} lg={9}>
              ...
              <img src={bot} alt="diagnosis" style={{height:'27px', width:'27px'}}/>
              <br />
              Get help from Medbay's symptoms checker<br /> which will help you identify what you're suffering from!(For information purposes only!)
              </Typography>
              </ButtonBase>
              </Paper>
            </Grid>
            <Grid item xs={12} md={8} lg={9} >
              <Paper className={fixedHeightDashboard} square={false} elevation={10} style={{backgroundColor: '#ccdbee'}} >
              <ButtonBase disableRipple style={{marginTop:'2%'}} onClick={() => history.push("/PatientMessaging")}>
              <Typography align='center' variant='subtitle2' >
