...
const headCells = [
  ...
  { id: 'warn', numeric: false, disablePadding: false, label: 'Send Warning' },
];
...
export default function EnhancedTable() {
  ...
  useEffect(async ()=> {
   ...
   function RowFormation(){
    setRows(
  doctors.map((r)=>
   createData(r.first_name+" "+r.last_name,r.email,r.phone_number,r.rating, <Warn />)  
 )
    )
  }
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center"> <Rating name="read-only" value={row.rate} readOnly size="large"/></TableCell>
